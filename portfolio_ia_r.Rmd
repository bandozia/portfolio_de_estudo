...
Exemplo: Teste da relação entre peso e altura em mulheres:
```{r}
women
...
O R ajustado de 0.9903 indica que este modelo tem capacida de explicação em 99.03% dos casos
...
### <a name="plot"></a> Scatter
Cada valor é representado por um ponto no eixo cartesiano
```{r}
